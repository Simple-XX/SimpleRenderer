...
model_t::material_t::~material_t(void) { return; }
...
model_t::vertex_t::vertex_t(void) { return; }
...
model_t::face_t::face_t(void) { return; }
...
model_t::box_t::box_t(void) { return; }
    ...
    for (size_t f = 0; f < shapes[s].mesh.num_face_vertices.size(); f++) {
      ...
      for (size_t v = 0; v < fv; v++) {
        ...
        if (idx.texcoord_index >= 0) {
          texcoord =
              texcoord_t(attrib.texcoords[2 * size_t(idx.texcoord_index) + 0],
      ...
      if (materials.empty() == false) {
        ...
        material.specular =
            vector4f_t(materials[s].specular[0], materials[s].specular[1],
