...
/// @todo 巨大性能开销
std::pair<bool, vector4f_t> framebuffer_t::get_barycentric_coord(
    const vector4f_t &_p0, const vector4f_t &_p1, const vector4f_t &_p2,
    const vector4f_t &_p) {
  auto ab = _p1 - _p0;
  auto ac = _p2 - _p0;
  auto ap = _p - _p0;
...
framebuffer_t::~framebuffer_t(void) { return; }
...
uint32_t framebuffer_t::get_width(void) const { return width; }

uint32_t framebuffer_t::get_height(void) const { return height; }
...
color_buffer_t &framebuffer_t::get_color_buffer(void) { return color_buffer; }

const color_buffer_t &framebuffer_t::get_color_buffer(void) const {
  return color_buffer;
}

depth_buffer_t &framebuffer_t::get_depth_buffer(void) { return depth_buffer; }

framebuffer_t::depth_t &framebuffer_t::get_depth_buffer(uint32_t _x,
                                                        uint32_t _y) {
