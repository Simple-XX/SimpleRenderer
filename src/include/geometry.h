...
private:
    ...
    bool is_barycentric(const Vectori3 &_vertex1, const Vectori3 &_vertex2, const Vectori3 &_vertex3, const Vectori3 &_p) const;
    // 获取最小 (x,y)
    ...
    // 获取最小 (x,y,z)
    Vectori3 get_min(const Vectori3 &_vertex1, const Vectori3 &_vertex2, const Vectori3 &_vertex3) const;
    // 获取最大 (x,y,z)
    Vectori3 get_max(const Vectori3 &_vertex1, const Vectori3 &_vertex2, const Vectori3 &_vertex3) const;
...
public:
    ...
    void line(int _x0, int _y0, int _z0, int _x1, int _y1, int _z1, double * _zbuffer, const TGAColor &_color) const;
    ...
    void triangle(const Vectori3 &_vertex1, const Vectori3 &_vertex2, const Vectori3 &_vertex3, double * _zbuffer, const TGAColor &_color) const;
    void triangle(const Vectori3 * _vertexes, double * _zbuffer, const TGAColor &_color) const;
    void circle(int _x0, int _y0, double _r, TGAColor _color) const;
    void circle(int _x0, int _y0, double _r, double * _zbuffer, const TGAColor &_color) const;
