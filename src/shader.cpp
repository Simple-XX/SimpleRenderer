...
shader_base_t::get_barycentric_coord(const vector4f_t& _p0,
...
shader_base_t::interpolate_depth(const framebuffer_t::depth_t& _depth0,
...
shader_base_t::interpolate_color(const model_t::color_t&  _c0,
