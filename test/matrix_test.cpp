...
TEST(matrix_t, rotate) {
    ...
    float res_arr7[4][4] = {
        ...
        {-0.3106172382831573,  0.5058794021606445,  0.8047378659248352, 0},
        {                  0,                   0,                   0, 1}
    };
    ...
    float res_arr8[4][4] = {
        ...
        {-0.1847639977931976,  0.9557201862335205,  0.2290436625480651, 0},
        {                  0,                   0,                   0, 1}
    };
    ...
    float res_arr9[4][4] = {
        ...
        {-0.1380711793899536,  0.1607873141765594,  0.9772838950157165, 0},
        {                  0,                   0,                   0, 1}
    };
    ...
    float res_arr10[4][4] = {
        ...
        {-0.289053618907928, 0.8514305949211120, 0.4376229643821716, 0},
        {                 0,                  0,                  0, 1}
    };
    ...
    float res_arr11[4][4] = {
        ...
        {-0.4466754198074340,  0.2839626669883728,   0.848437607288360, 0},
        {                  0,                   0,                   0, 1}
    };
